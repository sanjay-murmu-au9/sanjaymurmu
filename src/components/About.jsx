            ...
            >
                ...
                <div className="grid md:grid-cols-5 gap-12 mb-12">
                    ...
                    <div className="md:col-span-3 space-y-4 text-slate-600 dark:text-slate-400 text-base leading-relaxed">
                        ...
                        <p>
                            What sets me apart from a traditional backend engineer is my{' '}
                            <strong className="text-teal-600 dark:text-teal-300 font-medium">Product-Mindset</strong>.
                            I have a secondary expertise in{' '}
                            <span className="text-slate-800 dark:text-slate-200">
                                Facebook Ads, conversion-optimized landing pages, and funnel architecture
                            </span>.
                            This allows me to see the bigger picture—understanding how backend efficiency translates
                            directly into user acquisition, retention, and ultimately, ROI.
                        </p>
                    </div>

                    {/* Avatar — bigger */}
                    <div className="md:col-span-2 flex justify-center md:justify-end">
                        <div className="relative w-80 h-80 md:w-96 md:h-96 cursor-pointer group rounded-md">
