...
const skillCategories = [
    ...
    },
    {
        ...
        skills: ['Arrays & Strings', 'Linked Lists', 'Trees & Graphs', 'Dynamic Programming', 'Recursion & Backtracking', 'Sorting & Searching', 'Hashing', 'Sliding Window', 'Two Pointers', 'Heap / Priority Queue', 'BFS / DFS', 'LeetCode (300+ solved)']
    },
    {
        title: 'System Design',
        skills: ['Distributed Systems', 'Load Balancing', 'Database Sharding', 'CAP Theorem', 'Event-Driven Architecture', 'Rate Limiting', 'Horizontal Scaling', 'CDN & Caching Layers', 'Message Queues', 'API Gateway Design', 'High Availability', 'Fault Tolerance']
    }
];
